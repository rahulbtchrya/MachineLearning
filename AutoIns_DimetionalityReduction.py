...
This is the auto-insurance project -  AutoML

Here we are doing dimentionality reduction as per 
...
# This technique could have been used to seperate out column types but its not giving the correct reslts in this scenario
# df_unique_counts = df.nunique()
# print(df_unique_counts)
# for col in columns_list:
#     if df_unique_counts[col] == 2:
#         bin_cols.append(col)
#     elif (df_unique_counts[col] > 2) and (df_unique_counts[col] < 15):
#         cat_cols.append(col)
#     else:
#         num_cols.append(col)
